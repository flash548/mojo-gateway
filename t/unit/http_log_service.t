...
subtest 'Test Search Param Validation' => sub {
  ...
  # check status code
  $service->_validate_search_params($context, 'ok', undef, undef, undef, undef, undef, undef, undef, undef, undef);
  ...
  # check email param
  $service->_validate_search_params($context, 200, 'some@test.com;', undef, undef, undef, undef, undef, undef, undef, undef);
  ok $context->{render_called}, 'Test that early render was called';
  ok $context->{error_message}->{status} == 400;
  ...
  $service->_validate_search_params($context, 200, 'some@test.com', undef, ';df', undef, undef, undef, undef, undef, undef);
  ok $context->{render_called}, 'Test that early render was called';
  ok $context->{error_message}->{status} == 400;
  ...
  # check user agent
  $service->_validate_search_params($context, 200, 'some@test.com', undef, undef, ';sfdf', undef, undef, undef, undef, undef);
  ok $context->{render_called}, 'Test that early render was called';
  ok $context->{error_message}->{status} == 400;
  ...
  # check hostname
  $service->_validate_search_params($context, 200, 'some@test.com', undef, undef, undef, ';fdsf!', undef, undef, undef, undef);
  ok $context->{render_called}, 'Test that early render was called';
  ok $context->{error_message}->{status} == 400;
  ...
  # check query string
  $service->_validate_search_params($context, 200, 'some@test.com', undef, undef, undef, undef, 'sdf;!', undef, undef, undef);
  ok $context->{render_called}, 'Test that early render was called';
  ok $context->{error_message}->{status} == 400;
  ...
  # check time less
  $service->_validate_search_params($context, 200, 'some@test.com', undef, undef, undef, undef, undef, ';sdf', undef, undef);
  ok $context->{render_called}, 'Test that early render was called';
  ok $context->{error_message}->{status} == 400;
  ...
  # check time greater
  $service->_validate_search_params($context, 200, 'some@test.com', undef, undef, undef, undef, undef, undef, ';ff', undef);
  ok $context->{render_called}, 'Test that early render was called';
  ok $context->{error_message}->{status} == 400;
  ...
  # check user id
  $service->_validate_search_params($context, 200, 'some@test.com', undef, undef, undef, undef, undef, undef, undef, '___!!!');
  ok $context->{render_called}, 'Test that early render was called';
  ok $context->{error_message}->{status} == 400;
  ok $context->{error_message}->{json}->{message} eq 'User ID must be alphanumeric with hyphens';
  $context->_reset_render;
...
subtest 'Test Build Query' => sub {
  ...
  my ($query, $query_bindings, $count_query, $count_bindings)
    ...
    'logs', 'GET', 'mozilla', 'yahoo.com', 'test', 1000, 500, '1234-abcdef')->@*;
  ...
  ok $query =~ m/and lower\(user_id\) = \?/s, 'Test User Id Equals';
  ...
  ok $query_bindings->[11] eq '1234-abcdef', 'Test Query Bindings - 12'; 
